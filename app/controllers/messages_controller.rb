class MessagesController < ApplicationController
    ...
    def index
        ...
        @messages = Message.joins("left outer join users on messages.sender_user_id = users.id").select("messages.*, users.first_name, users.last_name").where("messages.sender_user_id=1")
